        ...
        return (
            <section className="hits-section">
                <div className="container">
                    <h2 className="hits-title" style={{color:"white"}}>Хиты продаж</h2>
        ...
        <section className="hits-section">
            <div className="container">
                <div className="hits-header">
                    <h2 className="hits-title" style={{color:"white"}}>Хиты продаж</h2>
                    {/*<p className="hits-subtitle">Самые популярные цветы среди наших покупателей</p>*/}
                </div>
                            ...
                            {products.map((product) => (
                                ...
                                >
                                    ...
                                    <div className="product-info">
                                        ...
                                        {/*    {product.truncatedDescription || product.description?.slice(0, 80) + '...'}*/}
                                        {/*</p>*/}
