        ...
        <div className="about-us-container">
            ...
            <section className="about-hero">
                <div className="hero-content">
                    <h1 className="hero-title">О компании <span className="hero-title-flower">FLOWER</span><span className="hero-title-kz">KZ</span></h1>
                        ...
                        <div className="mission-grid">
                            <div className="mission-text">
                                ...
                                <p>
                                        ...
                                        Мы верим, что <b style={{color:"green"}}>цветы</b> — это не просто растения, а настоящий язык чувств.
