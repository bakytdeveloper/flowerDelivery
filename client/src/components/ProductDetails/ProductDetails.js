...
//     }, [id]);
//
//     // НОВАЯ ФУНКЦИЯ: Загрузка вариантов товара
...
//     };
//
//     // НОВАЯ ФУНКЦИЯ: Получение текущей цены с учетом выбранной длины
...
//     };
//
//     // ОБНОВЛЕННАЯ ФУНКЦИЯ: Добавление товара в корзину с учетом цвета и длины
//     const handleAddProductToCart = async () => {
//         const productData = {
...
//                         </div>
//
//                         {/* НОВЫЙ БЛОК: ВЫБОР ЦВЕТА И ДЛИНЫ СТЕБЛЯ */}
...
//                             )}
//
//                             {/* Обновляем отображение длины стебля */}
//                             {selectedStemLength && (
//                                 <div className="spec-item">
//                                     <span className="spec-label">Длина стебля:</span>
